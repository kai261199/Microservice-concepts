...
using InventoryService.Api.Settings;

var builder = WebApplication.CreateBuilder(args);

// [OPTIONS PATTERN]
builder.Services.Configure<InventoryServiceSettings>(
    builder.Configuration.GetSection(InventoryServiceSettings.SectionName));
